...
class Checkout extends AbstractPageObject_1.AbstractPageObject {
    ...
    constructor() {
        super(hooks_1.page);
        this.basketCards = hooks_1.page.locator('[data-qa="basket-card"]');
        this.itemPrice = hooks_1.page.locator('[data-qa="basket-item-price"]');
        this.removeFormBasketButton = hooks_1.page.locator('[data-qa="basket-card-remove-item"]');
        this.continueToCheckoutButton = hooks_1.page.locator('[data-qa="continue-to-checkout"]');
        this.checkoutMenuButton = hooks_1.page.getByRole('link', { name: 'Checkout' });
    }
